...
- For export with URLs generated by frontend/backend internals, keep `FRONTEND_ASSET_BASE_URL=http://web:3000` in `.env`.
...
- Visual fidelity к Figma сделан по доступным референсам и MCP-метаданным, не pixel-perfect на всех экранах.
